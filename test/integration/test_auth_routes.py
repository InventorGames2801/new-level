...
class TestAuthRoutes:
    ...
    def test_login_valid_credentials(self, client, sample_user):
        ...
        response = client.post(
            "/login", data={"email": sample_user.email, "password": "testpassword"}
        )
    ...
    def test_login_invalid_email(self, client):
        ...
        response = client.post(
            "/login", data={"email": "nonexistent@example.com", "password": "anypassword"}
        )
    ...
    def test_login_invalid_password(self, client, sample_user):
        ...
        response = client.post(
            "/login", data={"email": sample_user.email, "password": "wrongpassword"}
        )
    ...
    def test_register_invalid_emails(self, client, invalid_email):
        ...
        response = client.post(
            "/register",
            data={"name": "Test User", "email": invalid_email, "password": "validpassword"},
        )
    ...
    def test_register_invalid_passwords(self, client, invalid_password):
        ...
        response = client.post(
            "/register",
            data={"name": "Test User", "email": "test@example.com", "password": invalid_password},
        )
