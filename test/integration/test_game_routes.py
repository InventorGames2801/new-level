...
class TestGameRoutes:
    ...
    def test_game_page_authenticated(self, authenticated_user_session, sample_words, sample_game_settings):
    ...
    def test_check_word_answer_correct(self, authenticated_user_session, sample_words):
        ...
        response = authenticated_user_session.post("/api/word/check", json={
            "word_id": word.id,
            "answer": "hello",
            "game_type": "scramble"
        })
    ...
    def test_check_word_answer_unauthenticated(self, client, sample_words):
        ...
        response = client.post("/api/word/check", json={
            "word_id": word.id,
            "answer": "hello",
            "game_type": "scramble"
        })
    ...
    def test_end_game_session_valid(self, authenticated_user_session, sample_game_session):
        ...
        response = authenticated_user_session.post("/api/game/end", json={
    ...
    def test_end_game_session_impossible_answers(self, authenticated_user_session, sample_game_session):
    ...
    def test_end_game_session_unauthenticated(self, client, sample_game_session):
        ...
        response = client.post("/api/game/end", json={
            "session_id": sample_game_session.id,
            "score": 100,
            "correct_answers": 5,
            "total_questions": 10
    ...
    def test_check_matching_answers(self, authenticated_user_session, sample_words):
        ...
        response = authenticated_user_session.post("/api/matching/check", json=[
            {
                "wordId": word.id,
                "answer": "привет"
            }
    ...
    def test_game_flow_integration(self, authenticated_user_session, sample_words, sample_game_settings):
        """Test complete game flow integration"""
        # 1. Start game session
        start_response = authenticated_user_session.post("/api/game/start", json={
            "game_type": "scramble"
        })
        ...
        for word_data in words:
            ...
            check_response = authenticated_user_session.post("/api/word/check", json={
        ...
        # 4. End game session
        end_response = authenticated_user_session.post("/api/game/end", json={
